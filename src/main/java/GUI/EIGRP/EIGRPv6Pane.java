...
public class EIGRPv6Pane
{
    ...
    public ObservableList<EIGRPv6Data> data = FXCollections.observableArrayList();
    ...
    protected Node constructPane(ObservableList<Interface> interfaces)
    {
        ...
        gridPane.setVgap(30);
        Label enableEIGRP = new Label("Enable EIGRPv6 process");
        ...
        autonomousSystemIDTextField.setId("EIGRPv6 AS number text field");
        routerIDTextField = new TextField();
        routerIDTextField.setId("EIGRPv6 Router ID text field");
        ...
        TableView<EIGRPv6Data> advertisedInterfaces = new TableView<>(data);

        advertisedInterfaces.setPrefSize(500, 250);
        advertisedInterfaces.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);

        TableColumn<EIGRPv6Data, String> interfaceColumn;
        TableColumn<EIGRPv6Data, String> passiveInterfaceColumn;

        TableColumn<EIGRPv6Data, String>[] columns = new TableColumn[]
                {
        ...
        add.setOnAction(event ->
        {
            ...
            if (!isDuplicate)
            {
                data.add(new EIGRPv6Data(iface, isPassive));
            }
        });
        ...
        return new GroupBox("EIGRPv6", box);
    }

    public static class EIGRPv6Data
    {
        private Interface iface;
        private boolean isPassive;
        private String passive;

        public EIGRPv6Data(Interface iface, boolean isPassive)
        {
            this.iface = iface;
