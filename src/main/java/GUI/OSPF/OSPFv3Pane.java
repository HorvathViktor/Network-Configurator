...
public class OSPFv3Pane
{
    ...
    public ObservableList<OSPFv3Data> data = FXCollections.observableArrayList();
    ...
    protected Node constructPane(ObservableList<Interface> interfaces)
    {
        ...
        westGrid.setVgap(30);
        Label enableOSPF = new Label("Enable OSPFv3 process");
        ...
        processIDTextField.setId("OSPFv3 Process ID text field");
        routerIDTextField = new TextField();
        routerIDTextField.setId("OSPFv3 Router ID text field");
        ...
        TableView<OSPFv3Data> advertisedInterfaces = new TableView<>(data);

        advertisedInterfaces.setPrefSize(500, 250);
        advertisedInterfaces.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);

        TableColumn<OSPFv3Data, String> interfaceColumn;
        TableColumn<OSPFv3Data, String> passiveInterfaceColumn;
        TableColumn<OSPFv3Data, String> areaColumn;

        TableColumn<OSPFv3Data, String>[] columns = new TableColumn[]
                {
        ...
        add.setOnAction(event ->
        {
            ...
            if(verify.isFlawless)
            {
                ...
                if (!isDuplicate)
                {
                    data.add(new OSPFv3Data(iface,isPassive,area));
                }
            }
        });
        ...
        return new GroupBox("OSPFv3", box);
    }
    public static class OSPFv3Data
    {
        ...
        public OSPFv3Data(Interface iface, boolean isPassive, int area)
        {
            this.iface = iface;
